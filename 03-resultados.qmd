...
Considerando os resultados de 2024, seguem os Detrans que obtiveram uma nota final acima de 7,0: `r print_results_text(tbl_final, "max")`. Dentre as menores notas, destaca-se os seguintes Detrans com as práticas mais iniciais: `r print_results_text(tbl_final, "min")`.
...
A @fig-dumbbell apresenta a variação entre os resultados de nota final obtidos na pesquisa de 2020 e na pesquisa atual de 2024. Dentre as 27 UFs, observa-se que 19 apresentaram uma evolução positiva neste período de tempo. Todos os estados da Região Sul, Sudeste e Centro-Oeste apresentaram aumento na nota final, comparando os períodos. Dois estados do Norte apresentaram aumento, em conjunto com 6 estados do Nordeste.
