...
A @tbl-final apresenta as notas calculadas das categorias analisadas e a média final do valor referente a 2024. Também inclui-se as médias finais obtidas no estudo de 2020, a fins de comparação com os valores atuais. Ao realizar uma média nacional com base nas notas de todas as UFs, em 2024 o Brasil atinge a nota de 5,64. Isso representa um aumento de 13,5%, considerando a média nacional obtida em 2020, que foi de 4,97.
...
De forma absoluta, os portais dos Detrans que apresentaram as melhores evoluções em relação foram aqueles dos estados do Rio Grande do Norte (+2,94), Acre (+2,69), Santa Catarina (+2,62), Bahia (+2,62) e Ceará (+2,30). De outro lado, os estados que apresentaram as maiores quedas de desempenho foram Roraima (-2,62), Rondônia (-1,83) e Piauí (-1,75). 
